...
loader.load('./assets/jantung.gltf', function (jantung) {
    ...
    function animate() {
        ...
        if (isSqueezing) {
            // Calculate the rotation amount based on the controllers' position change
            const rotationAmount = 1; // Adjust this value to control the rotation speed
            const scaleAmount = 0.01;
    
            
            // Calculate the change in controller positions
            ...
            // Use the position change to update the rotation of the "jantung" object
            mesh.rotation.z += controllerPosChange1.x * rotationAmount;
            mesh.rotation.z += controllerPosChange2.x * rotationAmount;
            const scaleChange1 = (controllerPosChange1.z / 10) * scaleAmount;
            const scaleChange2 = (controllerPosChange1.z / 10)* scaleAmount;

        // Apply the scale change to the "jantung" object
    ...
    dolly.add(  controller1, controller2, line, line2 , controllerGrip1 , controllerGrip2);
